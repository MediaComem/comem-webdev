...
- [Sharing changes](#sharing-changes)
  - [Bob: create a repository on GitHub](#a-create-a-repository-on-github)
  - [Bob: add B as a collaborator](#a-add-b-as-a-collaborator)
  - [Bob: copy the remote SSH URL](#a-copy-the-remote-ssh-url)
  - [Bob: add the remote to your local repository](#a-add-the-remote-to-your-local-repository)
  - [Bob: push your commits to the shared repository](#a-push-your-commits-to-the-shared-repository)
  - [Bob: remote branches](#a-remote-branches)
  - [Alice: get the remote repository's SSH URL](#b-get-the-remote-repositorys-ssh-url)
  - [Alice: clone the shared repository](#b-clone-the-shared-repository)
  - [Alice: remote branches](#b-remote-branches)
  - [Alice: make local changes](#b-make-local-changes)
  - [Alice: check the state of branches](#b-check-the-state-of-branches)
  - [Bob: check the state of branches](#a-check-the-state-of-branches)
  - [Bob: fetch changes from the shared repository](#a-fetch-changes-from-the-shared-repository)
  - [Bob: check the state of branches](#a-check-the-state-of-branches-1)
  - [Using git pull](#using-git-pull)
- [Managing conflicting commit histories](#managing-conflicting-commit-histories)
  - [Bob: fix the bug](#a-fix-the-bug)
  - [Alice: make other changes](#b-make-other-changes)
  - [Rejected pushes](#rejected-pushes)
  - [Divergent history](#divergent-history)
  - [Alice: pull changes from the shared repository](#b-pull-changes-from-the-shared-repository)
  - [Alice: check the conflict markers](#b-check-the-conflict-markers)
  - [Alice: check the state of branches](#b-check-the-state-of-branches-1)
  - [Alice: push the changes](#b-push-the-changes)
  - [Bob: pull the changes](#a-pull-the-changes)
